...
<body>
    ...
    <section class="right">
        ...
        <div class="tieude">
            <p><a href="admin_customer.php" style="color:black">Danh sách khách hàng</a> > Thêm khách hàng</p>
        </div>
        <div class="phan-vung">
            <form method="post">
                <hr class="line">
                <div class="thongtin">
                    <?php
                    if (isset($_GET['maKH'])){
                            include("../controllers/editkh.php");
                    } else  
                    {
                        include('../controllers/taomakh.php');
                        include('../modals/editkh.php');
                    }
                    ?>
                    <div class="capnhat">
                        <button type="button" class="luulai" onclick="showSuccessMessage2()">Lưu lại</button>
