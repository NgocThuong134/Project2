        ...
        <div class="phan-vung">
            <div class="thanhtieude">
                <div class="item themsp">
                    ...
                    <a href="edit_uudai.php">Thêm ưu đãi</a>
                </div>
            ...
            <div class="thanhbar">
                ...
                <div class="sapxep">
                    <label for="sapxep">Giá trị: </label>
                    <select id="sapxep" name="sapxep" onchange="SapXepUuDai()">
                ...
                <div class="timkiem">
                    ...
                    <input type="search" id="search" name="search" onchange="TimkiemUuDai()" />
                </div>
            </div>
            <div class="bangdulieu">
                <table>
                    ...
                    <tbody id="product-list">
                        <?php
                        include("../controllers/hienuudai.php");
                        ?>
                    </tbody>
                </table>
            </div>
