        ...
        <div class="phan-vung">
            <div class="thanhtieude">
                <div class="item themsp">
                    ...
                    <a href="editnv.php">Thêm nhân viên</a>
                </div>
            ...
            <div class="thanhbar">
                ...
                <div class="sapxep">
                    <label for="sapxem">Lương: </label>
                    <select id="sapxem" name="sapxem" onchange="SapXepLuong()">
                ...
                <div class="timkiem">
                    ...
                    <input type="search" id="search" name="search" onchange="TimkiemNV()" />
                </div>
            </div>
            <div class="bangdulieu">
                <table>
                    ...
                    <tbody id="product-list">
                        <?php
                        include("../controllers/hiennv.php");
                        ?>
                    </tbody>
                </table>
            </div>
