...
<body>
    ...
    <section class="right">
        ...
        <div class="tieude">
            <p><a href="admin_staff.php" style="color:black">Danh sách nhân viên</a> > Thêm nhân viên</p>
        </div>
        <div class="phan-vung">
            <form method="post">
                <hr class="line">
                <div class="thongtin">
                    <?php
                    if (isset($_GET['maNV'])){
                            include("../controllers/editnv.php");
                    } else  
                    {
                        include('../controllers/taomanv.php');
                        include('../modals/editnv.php');
                    }
                    ?>
                    <div class="capnhat">
                        <button type="button" class="luulai" onclick="showSuccessMessage3()">Lưu lại</button>
