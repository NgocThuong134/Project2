...
function addToCart3(foodid) {
  foodid = parseInt(foodid);
  var inputElement = document.getElementById("soluong");
  var soluong = inputElement.value;
  AddPhp(foodid, soluong);
}
function addToCartNgay(foodid) {
  foodid = parseInt(foodid);
  var inputElement = document.getElementById("soluong");
  var soluong = inputElement.value;
  AddPhp2(foodid, soluong);
}
function AddPhp2(foodid, soluong) {
  var xhr = new XMLHttpRequest();
  var url =
    "../controllers/add_cart.php?foodid=" + foodid + "&soluong=" + soluong;
              ...
              (function (j) {
                ...
                searchResult.addEventListener("click", function (event) {
                  ...
                  window.location.href =
                    "../pages/chitietmonan.php?foodid=" + foodId;
                });
              })(j);
            }
          } else {
